...
<html lang="en">
    <head>
        <title>My hobby - ESPORT Gallery</title>
                    ...
                    <li class="dropdown"><a><b>Gallery</b></a>
                        <div class="dropdown-content">
                            ...
                            <?php if(isset($_SESSION['user_id'])): ?>
                                <a href="/gallery_private">Gallery Private</a>
                            <?php endif;?>
                    ...
                    <div class="imagesGallery">
                        <?php foreach($images as $image):?>
                            <div class="imageGallery">
                                ...
                                <?php
                                    if (isset($_SESSION['C'.$page]))
                                    {
                                        $id = $image['_id'].'';
                                        if (array_key_exists($id, $_SESSION['C'.$page])) {
                                            echo 'checked';
                                        }
                                    }
                                ?>
                    ...
                    <div class="paging">
                        <?php 
                            for ($page = 1; $page <= $pages; $page++) {
                                echo '<a href="/gallery?page='.$page.'">'.$page.' strona  '.'</a>';
                            }
                        ?>
                    <div>
                    <br>
                    <input type="submit" name="save" value="Save" class="buttonGallery">
                </form>
            </div>
        </section>
